 ...
 */
export default class MedicinalProductPharmaceutical {
    /**
     * This is a MedicinalProductPharmaceutical resource
     */
    static readonly resourceType = "MedicinalProductPharmaceutical";
     ...
     */
    characteristics?: MedicinalProductPharmaceutical_Characteristics | MedicinalProductPharmaceutical_Characteristics[];

    /**
     * The path by which the pharmaceutical product is taken into or makes contact with the body.
     */
    routeOfAdministration: MedicinalProductPharmaceutical_RouteOfAdministration | MedicinalProductPharmaceutical_RouteOfAdministration[];
