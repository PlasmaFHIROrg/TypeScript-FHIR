 ...
 */
export default class ImplementationGuide_Manifest {
    /**
     ...
     */
    resource: ImplementationGuide_Resource1 | ImplementationGuide_Resource1[];

    /**
     * Information about a page within the IG.
     */
    page?: ImplementationGuide_Page1 | ImplementationGuide_Page1[];
