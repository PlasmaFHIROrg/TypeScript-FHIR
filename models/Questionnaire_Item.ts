 ...
 */
export default class Questionnaire_Item {
    /**
     ...
     */
    enableWhen?: Questionnaire_EnableWhen | Questionnaire_EnableWhen[];
     ...
     */
    answerOption?: Questionnaire_AnswerOption | Questionnaire_AnswerOption[];

    /**
     * One or more values that should be pre-populated in the answer when initially rendering the questionnaire for user input.
     */
    initial?: Questionnaire_Initial | Questionnaire_Initial[];

    /**
     * Text, questions and other groups to be nested beneath a question or group.
     */
    item?: Questionnaire_Item | Questionnaire_Item[];
