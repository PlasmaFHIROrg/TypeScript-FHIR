 ...
 */
export default class MedicationKnowledge {
    /**
     * This is a MedicationKnowledge resource
     */
    static readonly resourceType = "MedicationKnowledge";
     ...
     */
    _synonym?: Element | Element[];

    /**
     * Associated or related knowledge about a medication.
     */
    relatedMedicationKnowledge?: MedicationKnowledge_RelatedMedicationKnowledge | MedicationKnowledge_RelatedMedicationKnowledge[];

    /**
     * Associated or related medications.  For example, if the medication is a branded product (e.g. Crestor), this is the Therapeutic Moeity (e.g. Rosuvastatin) or if this is a generic medication (e.g. Rosuvastatin), this would link to a branded product (e.g. Crestor).
     */
    associatedMedication?: Reference | Reference[];

    /**
     * Category of the medication or product (e.g. branded product, therapeutic moeity, generic product, innovator product, etc.).
     */
    productType?: CodeableConcept | CodeableConcept[];

    /**
     * Associated documentation about the medication.
     */
    monograph?: MedicationKnowledge_Monograph | MedicationKnowledge_Monograph[];

    /**
     * Identifies a particular constituent of interest in the product.
     */
    ingredient?: MedicationKnowledge_Ingredient | MedicationKnowledge_Ingredient[];
     ...
     */
    intendedRoute?: CodeableConcept | CodeableConcept[];

    /**
     * The price of the medication.
     */
    cost?: MedicationKnowledge_Cost | MedicationKnowledge_Cost[];

    /**
     * The program under which the medication is reviewed.
     */
    monitoringProgram?: MedicationKnowledge_MonitoringProgram | MedicationKnowledge_MonitoringProgram[];

    /**
     * Guidelines for the administration of the medication.
     */
    administrationGuidelines?: MedicationKnowledge_AdministrationGuidelines | MedicationKnowledge_AdministrationGuidelines[];

    /**
     * Categorization of the medication within a formulary or classification system.
     */
    medicineClassification?: MedicationKnowledge_MedicineClassification | MedicationKnowledge_MedicineClassification[];
     ...
     */
    drugCharacteristic?: MedicationKnowledge_DrugCharacteristic | MedicationKnowledge_DrugCharacteristic[];
     ...
     */
    regulatory?: MedicationKnowledge_Regulatory | MedicationKnowledge_Regulatory[];

    /**
     * The time course of drug absorption, distribution, metabolism and excretion of a medication from the body.
     */
    kinetics?: MedicationKnowledge_Kinetics | MedicationKnowledge_Kinetics[];
