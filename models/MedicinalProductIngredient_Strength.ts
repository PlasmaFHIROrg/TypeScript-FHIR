 ...
 */
export default class MedicinalProductIngredient_Strength {
    /**
     ...
     */
    referenceStrength?: MedicinalProductIngredient_ReferenceStrength | MedicinalProductIngredient_ReferenceStrength[];
