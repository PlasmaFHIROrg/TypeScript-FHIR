 ...
 */
export default class CommunicationRequest {
    /**
     * This is a CommunicationRequest resource
     */
    static readonly resourceType = "CommunicationRequest";
     ...
     */
    medium?: CodeableConcept | CodeableConcept[];
     ...
     */
    payload?: CommunicationRequest_Payload | CommunicationRequest_Payload[];
