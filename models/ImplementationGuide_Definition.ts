 ...
 */
export default class ImplementationGuide_Definition {
    /**
     ...
     */
    grouping?: ImplementationGuide_Grouping | ImplementationGuide_Grouping[];

    /**
     * A resource that is part of the implementation guide. Conformance resources (value set, structure definition, capability statements etc.) are obvious candidates for inclusion, but any kind of resource can be included as an example resource.
     */
    resource: ImplementationGuide_Resource | ImplementationGuide_Resource[];
     ...
     */
    parameter?: ImplementationGuide_Parameter | ImplementationGuide_Parameter[];

    /**
     * A template for building resources.
     */
    template?: ImplementationGuide_Template | ImplementationGuide_Template[];
