 ...
 */
export default class Contract_Term {
    /**
     ...
     */
    securityLabel?: Contract_SecurityLabel | Contract_SecurityLabel[];
     ...
     */
    asset?: Contract_Asset | Contract_Asset[];

    /**
     * An actor taking a role in an activity for which it can be assigned some degree of responsibility for the activity taking place.
     */
    action?: Contract_Action | Contract_Action[];

    /**
     * Nested group of Contract Provisions.
     */
    group?: Contract_Term | Contract_Term[];
