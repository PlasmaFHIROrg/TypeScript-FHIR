 ...
 */
export default class ImmunizationRecommendation_Recommendation {
    /**
     ...
     */
    contraindicatedVaccineCode?: CodeableConcept | CodeableConcept[];
     ...
     */
    forecastReason?: CodeableConcept | CodeableConcept[];

    /**
     * Vaccine date recommendations.  For example, earliest date to administer, latest date to administer, etc.
     */
    dateCriterion?: ImmunizationRecommendation_DateCriterion | ImmunizationRecommendation_DateCriterion[];
     ...
     */
    supportingImmunization?: Reference | Reference[];

    /**
     * Patient Information that supports the status and recommendation.  This includes patient observations, adverse reactions and allergy/intolerance information.
     */
    supportingPatientInformation?: Reference | Reference[];
