 ...
 */
export default class RequestGroup_Action {
    /**
     ...
     */
    condition?: RequestGroup_Condition | RequestGroup_Condition[];

    /**
     * A relationship to another action such as "before" or "30-60 minutes after start of".
     */
    relatedAction?: RequestGroup_RelatedAction | RequestGroup_RelatedAction[];
