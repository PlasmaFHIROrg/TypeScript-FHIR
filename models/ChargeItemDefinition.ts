 ...
 */
export default class ChargeItemDefinition {
    /**
     * This is a ChargeItemDefinition resource
     */
    static readonly resourceType = "ChargeItemDefinition";
     ...
     */
    derivedFromUri?: string | string[];

    /**
     * Extensions for derivedFromUri
     */
    _derivedFromUri?: Element | Element[];
     ...
     */
    applicability?: ChargeItemDefinition_Applicability | ChargeItemDefinition_Applicability[];

    /**
     * Group of properties which are applicable under the same conditions. If no applicability rules are established for the group, then all properties always apply.
     */
    propertyGroup?: ChargeItemDefinition_PropertyGroup | ChargeItemDefinition_PropertyGroup[];
