 ...
 */
export default class SpecimenDefinition_TypeTested {
    /**
     ...
     */
    rejectionCriterion?: CodeableConcept | CodeableConcept[];

    /**
     * Set of instructions for preservation/transport of the specimen at a defined temperature interval, prior the testing process.
     */
    handling?: SpecimenDefinition_Handling | SpecimenDefinition_Handling[];
