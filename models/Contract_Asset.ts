 ...
 */
export default class Contract_Asset {
    /**
     ...
     */
    context?: Contract_Context | Contract_Context[];
     ...
     */
    periodType?: CodeableConcept | CodeableConcept[];
     ...
     * Response to assets.
     */
    answer?: Contract_Answer | Contract_Answer[];
     ...
     */
    valuedItem?: Contract_ValuedItem | Contract_ValuedItem[];
