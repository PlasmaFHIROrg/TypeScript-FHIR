 ...
 */
export default class RiskEvidenceSynthesis_RiskEstimate {
    /**
     ...
     */
    precisionEstimate?: RiskEvidenceSynthesis_PrecisionEstimate | RiskEvidenceSynthesis_PrecisionEstimate[];
