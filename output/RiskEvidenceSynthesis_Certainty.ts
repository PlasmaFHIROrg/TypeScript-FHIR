 ...
 */
export default class RiskEvidenceSynthesis_Certainty {
    /**
     ...
     */
    certaintySubcomponent?: RiskEvidenceSynthesis_CertaintySubcomponent | RiskEvidenceSynthesis_CertaintySubcomponent[];
