...
export default class Device {
     ...
     */
    udiCarrier?: Device_UdiCarrier | Device_UdiCarrier[];
     ...
     */
    deviceName?: Device_DeviceName | Device_DeviceName[];
     ...
     */
    specialization?: Device_Specialization | Device_Specialization[];

    /**
     * The actual design of the device or software version running on the device.
     */
    version?: Device_Version | Device_Version[];

    /**
     * The actual configuration settings of a device as it actually operates, e.g., regulation status, time properties.
     */
    property?: Device_Property | Device_Property[];
