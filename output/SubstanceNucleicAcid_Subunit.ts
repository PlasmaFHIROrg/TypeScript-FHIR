 ...
 */
export default class SubstanceNucleicAcid_Subunit {
    /**
     ...
     */
    linkage?: SubstanceNucleicAcid_Linkage | SubstanceNucleicAcid_Linkage[];

    /**
     * 5.3.6.8.1 Sugar ID (Mandatory).
     */
    sugar?: SubstanceNucleicAcid_Sugar | SubstanceNucleicAcid_Sugar[];
