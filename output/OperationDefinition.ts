 ...
 */
export default class OperationDefinition {
    /**
     * This is a OperationDefinition resource
     */
    static readonly resourceType = "OperationDefinition";
     ...
     */
    parameter?: OperationDefinition_Parameter | OperationDefinition_Parameter[];

    /**
     * Defines an appropriate combination of parameters to use when invoking this operation, to help code generators when generating overloaded parameter sets for this operation.
     */
    overload?: OperationDefinition_Overload | OperationDefinition_Overload[];
