 ...
 */
export default class ExampleScenario_Instance {
    /**
     ...
     */
    version?: ExampleScenario_Version | ExampleScenario_Version[];

    /**
     * Resources contained in the instance (e.g. the observations contained in a bundle).
     */
    containedInstance?: ExampleScenario_ContainedInstance | ExampleScenario_ContainedInstance[];
