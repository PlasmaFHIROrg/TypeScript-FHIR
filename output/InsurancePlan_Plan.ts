 ...
 */
export default class InsurancePlan_Plan {
    /**
     ...
     */
    generalCost?: InsurancePlan_GeneralCost | InsurancePlan_GeneralCost[];

    /**
     * Costs associated with the coverage provided by the product.
     */
    specificCost?: InsurancePlan_SpecificCost | InsurancePlan_SpecificCost[];
