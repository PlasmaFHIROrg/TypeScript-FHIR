...
export default class Composition {
     ...
     */
    static readonly resourceType = "Composition";
     ...
     */
    attester?: Composition_Attester | Composition_Attester[];
     ...
     */
    relatesTo?: Composition_RelatesTo | Composition_RelatesTo[];

    /**
     * The clinical service, such as a colonoscopy or an appendectomy, being documented.
     */
    event?: Composition_Event | Composition_Event[];

    /**
     * The root of the sections that make up the composition.
     */
    section?: Composition_Section | Composition_Section[];
