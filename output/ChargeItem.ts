 ...
 */
export default class ChargeItem {
    /**
     * This is a ChargeItem resource
     */
    static readonly resourceType = "ChargeItem";
     ...
     */
    definitionUri?: string | string[];

    /**
     * Extensions for definitionUri
     */
    _definitionUri?: Element | Element[];

    /**
     * References the source of pricing information, rules of application for the code this ChargeItem uses.
     */
    definitionCanonical?: string | string[];
     ...
     */
    performer?: ChargeItem_Performer | ChargeItem_Performer[];
