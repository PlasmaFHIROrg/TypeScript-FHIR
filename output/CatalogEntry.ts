...
export default class CatalogEntry {
     ...
     */
    static readonly resourceType = "CatalogEntry";
     ...
     */
    additionalIdentifier?: Identifier | Identifier[];
     ...
     */
    additionalCharacteristic?: CodeableConcept | CodeableConcept[];

    /**
     * User for example for ATC classification, or.
     */
    additionalClassification?: CodeableConcept | CodeableConcept[];

    /**
     * Used for example, to point to a substance, or to a device used to administer a medication.
     */
    relatedEntry?: CatalogEntry_RelatedEntry | CatalogEntry_RelatedEntry[];
