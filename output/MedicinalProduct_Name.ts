 ...
 */
export default class MedicinalProduct_Name {
    /**
     ...
     */
    namePart?: MedicinalProduct_NamePart | MedicinalProduct_NamePart[];

    /**
     * Country where the name applies.
     */
    countryLanguage?: MedicinalProduct_CountryLanguage | MedicinalProduct_CountryLanguage[];
