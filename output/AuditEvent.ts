...
export default class AuditEvent {
     ...
     */
    static readonly resourceType = "AuditEvent";
     ...
     */
    purposeOfEvent?: CodeableConcept | CodeableConcept[];

    /**
     * An actor taking an active role in the event or activity that is logged.
     */
    agent: AuditEvent_Agent | AuditEvent_Agent[];
     ...
     */
    entity?: AuditEvent_Entity | AuditEvent_Entity[];
